 ...
 * Purpose:  Compute and Display Average Test Scores and Drop Lowest Score
 */
...
int main(int argc, char** argv) {
    ...
    dropScr(tstScrs,numScrs);       //Drop lowest test score
...
void dropScr(float *ptr,int &tot){
    // Drop The Lowest Test Score By Shifting Elements In Array
    for(int i=0;i<tot;i++){
        *(ptr+i)=*(ptr+i+1);
    }
    // Assign A New Total Number Of Elements In Array
    tot--;
}
//Compute Average
