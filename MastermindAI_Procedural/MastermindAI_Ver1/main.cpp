 ...
 * Purpose: Mastermind Project AI Version 1
 * Description: Barebones Mastermind Project with Linear Search, 
 *              next version will incorporate another algorithm
 *              when solving the code.
 */
